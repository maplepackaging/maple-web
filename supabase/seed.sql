...
('hampers-gifts', 'Hampers & Gifts', 'hampers-gifts', 'Thoughtfully curated hampers for every occasion and every relationship', 'https://images.unsplash.com/photo-1549465220-1a8b9238f53e?w=800&q=80', 4),
...
('P005', 'Rattan Hamper Basket', 'Handwoven rattan basket with leather handles. A timeless packaging choice that doubles as home décor.', 280, 350, ARRAY['https://images.unsplash.com/photo-1549465220-1a8b9238f53e?w=600&q=80'], 'gift-packaging', 'gp-baskets', ARRAY['rattan','handwoven','eco','basket'], true, false),
...
('P008', 'Diwali Luxe Hamper', 'Premium Diwali hamper featuring artisanal sweets, dry fruits, scented candles, and a silk potli — all presented in a handcrafted MDF box.', 1800, 2200, ARRAY['https://images.unsplash.com/photo-1549465220-1a8b9238f53e?w=600&q=80'], 'hampers-gifts', 'hg-occasions', ARRAY['diwali','festive','luxe','hamper','sweets'], true, true);
